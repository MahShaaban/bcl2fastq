...
# Make inputs
echo -e "cohort,bcl,sample_sheet,undetermined,stats" > input/cohorts.info.csv
echo -e "pheno,input/200624_A00834_0183_BHMTFYDRXX,input/SampleSheet.csv,input/Undetermined_S0_L001_R1_001.fastq.gz,input/Stats.json" >> input/cohorts.info.csv
